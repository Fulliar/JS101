...
let arrJapanFoods = menu.filter(item => item.category == "Japan");
...
let arrChinaFoods = menu.filter(item => item.category == "China");
...
let arrKoreaFoods = menu.filter(item => item.category == "Korea");
